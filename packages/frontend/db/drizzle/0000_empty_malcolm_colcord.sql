...
CREATE TABLE "chats" (
	...
	CONSTRAINT "chats_tgId_unique" UNIQUE("tgId")
);
--> statement-breakpoint
...
CREATE TABLE "messages" (
	...
	"chat_id" uuid NOT NULL,
	"user_id" uuid,
	CONSTRAINT "messages_tgId_unique" UNIQUE("tgId")
);
--> statement-breakpoint
CREATE TABLE "users" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "chat_to_user" ADD CONSTRAINT "chat_to_user_chatId_chats_id_fk" FOREIGN KEY ("chatId") REFERENCES "public"."chats"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "chat_to_user" ADD CONSTRAINT "chat_to_user_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "chats" ADD CONSTRAINT "chats_balanceId_chat_balance_id_fk" FOREIGN KEY ("balanceId") REFERENCES "public"."chat_balance"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "users" ADD CONSTRAINT "users_balanceId_user_balance_id_fk" FOREIGN KEY ("balanceId") REFERENCES "public"."user_balance"("id") ON DELETE cascade ON UPDATE no action;